...
class MainToolbar extends JPanel
{
	...
	MainToolbar (JFrame contentFrame)
	{
		...
		java.net.URL imageURL = cldr.getResource("resources/full-extent-32.gif");
		...
		java.net.URL addLayerURL = cldr.getResource("resources/addLayer-32.png");
		...
		java.net.URL createCartogramURL = cldr.getResource("resources/buildAndGo-32.png");
		...
		java.net.URL svgURL = cldr.getResource("resources/export-to-svg-32.png");
		...
		java.net.URL shpURL = cldr.getResource("resources/export-to-shp-32.png");
