...
class CartogramWizardPanelZero extends JPanel implements HyperlinkListener
{
	...
	CartogramWizardPanelZero (JFrame contentFrame)
	{
		...
		ClassLoader cldr = this.getClass().getClassLoader();
		URL wizardStepZeroURL = cldr.getResource("resources/WizardIntroduction.html");
	...
	CartogramWizardPanelOne (JFrame contentFrame)
	{
		...
		try
		{
			InputStream inStream = 
				cldr.getResource("resources/LayerMenuText.rtf").openStream();
...
class CartogramWizardPanelTwo extends JPanel implements HyperlinkListener
{
	...
	CartogramWizardPanelTwo (JFrame contentFrame)
	{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/AttributeMenuText.rtf").openStream();
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/AttributeTypeText.html").openStream();
...
class CartogramWizardPanelThree extends JPanel
{
	...
	CartogramWizardPanelThree (JFrame contentFrame)
	{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/SimLayersText.rtf").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/ConstLayersText.rtf").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
...
class CartogramWizardPanelFour extends JPanel
{
	...
	CartogramWizardPanelFour (JFrame contentFrame)
	{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/AmountOfDeformationText.rtf").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/AdvancedOptionsText.rtf").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
	...
	implements HyperlinkListener, ChangeListener
{
	...
	CartogramWizardOptionsWindow ()
	{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/DeformationGridLayerText.html").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/ManualParametersText.html").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
		...
		{
			InputStream inStream = 
				cldr.getResource("resources/Grid1Text.html").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
		...
		try
		{
			InputStream inStream = cldr.getResource("resources/BiasText.html").openStream();
			StringBuffer inBuffer = new StringBuffer();
			int c;
			while ((c = inStream.read()) != -1)
			{
